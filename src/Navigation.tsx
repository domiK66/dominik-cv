...
export default function Navigation() {
  ...
  return (
    <div className="w-full justify-center items-center flex">
      ...
      <div
        className="flex fixed border rounded-xl border-mainColor z-10 top-4 overflow-hidden right-4 lg:visible invisible"
        style={{
          backgroundColor: "rgba(var(--mainColor-rgb), 0.25)",
          backdropFilter: "blur(10px)",
        }}
      ...
      <div
        className="flex fixed border rounded-xl border-mainColor z-10 bottom-4 overflow-hidden visible lg:invisible left-4"
        style={{
          backgroundColor: "rgba(var(--mainColor-rgb), 0.25)",
          backdropFilter: "blur(10px)",
        }}
